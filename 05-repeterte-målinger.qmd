...
Den gjennomsnittlige prosentvise økningen i ytelsesvekt ved 1RM (målt i kg) for henholdsvis tre og ett sett var `r round(perc_change2[2, 4], 2)` og `r round(perc_change2[1, 4], 2)`. Den gjennomsnittlige forskjellen i ytelsesvekt mellom beina ved de ulike treningsvolumene (ett sett vs. tre sett) var `r strength.results`.
