...
Ved start på forsøket ble ferdig cDNA utdelt fra et tidligere gjennomført styrkeprosjekt av labansvarlig. For å kunne kjøre en qPCR ble det brukt cDNA og en Master mix. Denne Master mixen bestod av 50 &micro;l SYBR-green, 20 &micro;l H~2~O og 10 &micro;l primer mix (myhc I, myhc IIx eller myhc IIa). Det ble i tillegg laget en Master mix som kontroll. Denne mestod av 50 &micro;l b2m primer mix, 100 &micro;l H~2~O og 250 &micro;l SYBR-green. 
...
Forsøket innebar i tillegg å lage to fortynningsrekker (se @tbl-fortynn). Der ble det brukt cmyc primer som ble fortynnet med H~2~O. I 1/1 prøven var det 30 &micro;l ved start. 1/1 prøven ble benyttet i fortynningen av de andre prøvene. Det var til slutt 20 &micro;l i alle fortynningene.  
...
Videre ble prøvene pippetert over i brønner etter pippeteringskartet i @tbl-gener. Brønnene ble fylt med 8 &micro;l primer-spesifikk prøve samt 2 &micro;l cDNA-løsning eller kontrolløsning. Deretter ble fortynningsrekkene (@tbl-fortynning) pippetert over i sine respektive brønner. Dette ble utført i triplikat for samtlige prøver.
